...
En el componente **Button**, necesitaremos importar el componente **Button** e implementarlo. Podemos implementar los botones que deseemos, en nuestro caso solo coloque 2.
